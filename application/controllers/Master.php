...
*/
  public function recruitment()
  {
    // Department Data
    $d['title'] = 'Recruitment';
    $d['Recruitment'] = $this->db->get('Recruitment')->result_array();
    $d['account'] = $this->Admin_model->getAdmin($this->session->userdata['username']);

    $this->load->view('templates/table_header', $d);
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/recruitment/index', $d); // Department Page
    $this->load->view('templates/table_footer');
  }

  public function a_recruitment()
  {
    // Add Employee
    $d['title'] = 'Recruitment';
    $d['department'] = $this->db->get('department')->result_array();
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/recruitment/a_recruitment', $d); // Add Employee Page
    $this->load->view('templates/footer');
  }
  public function promotion()
  {
    // Department Data
    $d['title'] = 'Promotion';
    $d['Promotion'] = $this->db->get('Promotion')->result_array();
    $d['account'] = $this->Admin_model->getAdmin($this->session->userdata['username']);

    $this->load->view('templates/table_header', $d);
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/promotion/index', $d); // Department Page
    $this->load->view('templates/table_footer');
  }

  public function a_promotion()
  {
    // Add Employee
    $d['title'] = 'Promotion';
    $d['department'] = $this->db->get('department')->result_array();
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/promotion/a_promotion', $d); // Add Employee Page
    $this->load->view('templates/footer');
  }
  public function position()
  {
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/position/index', $d); // Department Page
    $this->load->view('templates/table_footer');
  }
  ...
  public function a_position()
  {
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/position/a_position', $d); // Add Employee Page
    $this->load->view('templates/footer');
  }
  ...
  public function e_position($p_rate)
  {
    ...
    if ($this->form_validation->run() == false) {
      ...
      $this->load->view('templates/sidebar');
      $this->load->view('templates/topbar');
      $this->load->view('master/position/e_position', $d); // Edit Position Page
      $this->load->view('templates/footer');
    } else {
      $name = $this->input->post('p_name');
  ...
  public function holidays()
  {
    // Department Data
    $d['title'] = 'Holidays';
    $d['Holidays'] = $this->db->get('Holidays')->result_array();
    $d['account'] = $this->Admin_model->getAdmin($this->session->userdata['username']);

    $this->load->view('templates/table_header', $d);
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/holidays/index', $d); // Department Page
    $this->load->view('templates/table_footer');
  }

  public function a_holidays()
  {
    // Add Employee
    $d['title'] = 'Position';
    $d['department'] = $this->db->get('department')->result_array();
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/holidays/a_holidays', $d); // Add Employee Page
    $this->load->view('templates/footer');
  }
  public function leaves()
  {
    // Department Data
    $d['title'] = 'Leaves';
    $d['Leaves'] = $this->db->get('Leaves')->result_array();
    $d['account'] = $this->Admin_model->getAdmin($this->session->userdata['username']);

    $this->load->view('templates/table_header', $d);
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/leaves/index', $d); // Department Page
    $this->load->view('templates/table_footer');
  }

  public function a_leaves()
  {
    // Add Employee
    $d['title'] = 'Leaves';
    $d['department'] = $this->db->get('department')->result_array();
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/leaves/a_leaves', $d); // Add Employee Page
    $this->load->view('templates/footer');
  }
