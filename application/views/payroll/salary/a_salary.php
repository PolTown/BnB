        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-3">
              <a href="<?= base_url('payroll/salary'); ?>" class="btn btn-light bg-gradient-light border btn-icon-split mb-4 rounded-0">
              ...
              <div class="card rounded-0">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group row">
                        <label for="e_birth_date" class="col-form-label col-lg-4">Date of Salary</label>
