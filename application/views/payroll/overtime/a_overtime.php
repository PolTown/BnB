        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-3">
              <a href="<?= base_url('payroll/overtime/index'); ?>" class="btn btn-light bg-gradient-light border btn-icon-split mb-4 rounded-0">
          ...
          <div class="row justify-content-center">
            <div class="col-lg-10 p-0">
              <?= form_open_multipart('payroll/payroll'); ?>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      ...
                      <div class="form-group row">
                        <label for="e_name" class="col-form-label col-lg-4">Shift</label>
                        <div class="col p-0">
                          <input type="text" class="form-control col-lg" name="e_name" id="e_name" autofocus>
                          <?= form_error('e_name', '<small class="text-danger">', '</small>') ?>
                        </div>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group row">
                        <label for="e_birth_date" class="col-form-label col-lg-4">Date of overtime</label>
                      ...
                      <div class="form-group row">
                        <label for="e_name" class="col-form-label col-lg-4">Rate</label>
                        <div class="col p-0">
                          <input type="text" class="form-control col-lg" name="e_name" id="e_name" autofocus>
                          <?= form_error('e_name', '<small class="text-danger">', '</small>') ?>
                        </div>
