              ...
              <div class="card rounded-0">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="position_id" class="col-form-label-lg">Position ID</label>
                    <input type="text" readonly class="form-control-plaintext form-control-lg" name="p_id" value="<?= $p_old['id']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="d_name" class="col-form-label-lg">Position Name</label>
                    <input type="text" class="form-control form-control-lg" name="p_name" id="p_name" value="<?= $p_old['name']; ?>">
