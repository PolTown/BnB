              ...
              <div class="card-body">
                ...
                <form>
                  ...
                  <div class="form-group">
                    <label for="p_id" class="col-form-label-lg">Postion Name</label>
                    <input type="text" class="form-control form-control-lg" autofocus name="p_id" id="p_id" value="<?= !empty($this->input->post('p_id')) ? $this->input->post('p_id') : '' ?>">
                    <?= form_error('p_id', '<small class="text-danger">', '</small>') ?>
                  </div>
                  <div class="form-group">
                    <label for="p_name" class="col-form-label-lg">Rate</label>
                    <input type="text" class="form-control form-control-lg" name="p_name" id="p_name" value="<?= !empty($this->input->post('po_id')) ? $this->input->post('p_name') : '' ?>">
